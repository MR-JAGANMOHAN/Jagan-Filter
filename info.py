...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1459910748').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001840167833 -1001979162231').split()]
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Telegram", "Tgfiles")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Tgfiles', 'Telegram_files')
